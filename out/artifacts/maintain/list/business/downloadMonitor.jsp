...
var dynamicGrid = new Ext.grid.DynamicGrid({  
    ...
    storeUrl: 'redis!query.action?type=downLoadMonitorService&t='+new Date(),  
    width : '100%',  
    height: 500,  
    //rowNumberer: true,  
			...
			items:[
				{
					...
					items:[
						...
						{items: [{xtype:'textfield',enableKeyEvents:true,fieldLabel: '查询月份',id: 'queryMonth', name: 'queryMonth',value:'201304',anchor:'90%',
								listeners : {
