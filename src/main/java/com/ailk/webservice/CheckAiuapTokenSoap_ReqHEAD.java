 ...
 */
@XStreamAlias("HEAD")
public class CheckAiuapTokenSoap_ReqHEAD {

    public CheckAiuapTokenSoap_ReqHEAD(){}
    ...
    public CheckAiuapTokenSoap_ReqHEAD(String CODE,String SID,String TIMESTAMP,String SERVICEID ){
        this.CODE = CODE;
        this.SID = SID;
