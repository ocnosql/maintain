 ...
 */
@XStreamAlias("HEAD")
public class UpdateAppAcctSoap_RspHEAD {

    public UpdateAppAcctSoap_RspHEAD(){}
    ...
    public UpdateAppAcctSoap_RspHEAD(String CODE, String SID, String TIMESTAMP, String SERVICEID){
        this.CODE = CODE;
        this.SID = SID;
