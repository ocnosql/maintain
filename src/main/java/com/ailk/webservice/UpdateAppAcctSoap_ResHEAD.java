 ...
 */
@XStreamAlias("HEAD")
public class UpdateAppAcctSoap_ResHEAD {

    public UpdateAppAcctSoap_ResHEAD(){}

    /**
     * CODE	消息标志，暂不填，预留	String	16
     */
    @XStreamAlias("CODE")
    public String CODE;
    ...
    public UpdateAppAcctSoap_ResHEAD(String CODE, String SID, String TIMESTAMP, String SERVICEID){
        this.CODE = CODE;
        this.SID = SID;
